...
public class ProductRespositoryImpl implements ProductRespository {
    ...
    public List<Product> ProductRespositoryImpl() {
        ...
        Product product5 = new Product(5L, "Tetero", "Bebé", 10.000);
        Product product6 = new Product(6L, "Cuna", "Bebé", 25.000);
    ...
    public List<ProductDto> getAllProducts() {
        return ProductoMapper.mapFrom(products);
    }
}
